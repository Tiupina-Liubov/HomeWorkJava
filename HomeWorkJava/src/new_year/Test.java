...
public class Test {
    public static void main(String[] args) {
        ...
        Handler.setParticipantTeams(Generator.genTeams(5, 2, Teenager.class));
        Handler.setParticipantTeams(Generator.genTeams(5, 2, Pupil.class));
        Handler.setParticipantTeams(Generator.genTeams(5, 2, Adult.class));
