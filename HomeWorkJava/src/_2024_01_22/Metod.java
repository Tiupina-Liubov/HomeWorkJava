    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("/Users/luibov/Desktop/proekt/HomeWorkJava/HomeWorkJava/src/_2024_01_22/f.txt"));
            ...
            List<String> list = reader.lines()
                    .filter(line -> parseDouble(line.split(", ")[1]) > 4.5d)
                    .toList();
writer.write("Cтримы, имеющие рейтинг выше 4.5"+"\n");
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("/Users/luibov/Desktop/proekt/HomeWorkJava/HomeWorkJava/src/_2024_01_22/f.txt"));
             BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/luibov/Desktop/proekt/HomeWorkJava/HomeWorkJava/src/_2024_01_22/result_task_1.txt"))) {
            ...
            // writer.append(String.valueOf(strings));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
