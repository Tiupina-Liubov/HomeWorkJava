...
//       которые начинаются с гласной буквы.
        ...
        str.put(1, new ArrayList<>(Arrays.asList("Hallo", "main", "Liubov", "Tiupina")));
        str.put(2, new ArrayList<>(Arrays.asList("hallo", "Main", "liuv", "Tiupna")));
        str.put(9, new ArrayList<>(Arrays.asList("hallo", "Main", "iola", "Tiuina")));
        str.put(3, new ArrayList<>(Arrays.asList("allo", "main", "Liubov", "tiupinana")));
        str.put(4, new ArrayList<>(Arrays.asList("lo", "main", "Liov", "Tipina")));
...
//        первого, и выведите их.
        ...
        stringIntegerMap1.put("A",1);
        stringIntegerMap1.put("B",2);
        stringIntegerMap1.put("C",3);
        stringIntegerMap1.put("D",4);
        stringIntegerMap1.put("E",5);
        ...
        stringMap1.put(4, Arrays.asList("Kris","Anna","Kola"));
        stringMap1.put(3, Arrays.asList("Liuba","Anna","Andrey"));
        stringMap1.put(2, Arrays.asList("Vasa","Anna","Katya"));
...
//        List<String> letterVowel=new ArrayList<>(Arrays.asList("A","O","U","E","I","Y"));
//        for (String srt:stringList){
//            if(letterVowel.get(0).startsWith(srt)){
//
//            }
//        }
//    }
